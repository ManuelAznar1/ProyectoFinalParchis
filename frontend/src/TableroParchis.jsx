...
import { posicionesIniciales, moverFichaTablero, esMiTurno, verificarMovimientosPosibles, comprobarGanador } from "./logicaParchis";
...
//    const [dadoYaTirado, setDadoYaTirado] = useState(null);
    ...
    useImperativeHandle(ref, () => ({
            ...
            recibirDado(valor) {
                console.log("Recibido en TableroParchis el dado :", valor);
                setDado(valor);
            ...
            cambiarPosicionesDesdeSocket(posicionesSocket) {
                console.log("Recibido en Tablero Parchis posiciones:", posicionesSocket);
                setPosiciones(posicionesSocket);

                const hayGanador = comprobarGanador(posicionesSocket);
            ...
            <table border="1" >
                <tbody>
                    <tr>
                        ...
                        <td colSpan={2} className="seguro horizontal" id="seguro-cell-68"><span className="numero">O</span> {renderFichasEnCelda("seguro-cell-68")}</td>
                    ...
                    <tr>
                        ...
                        <td rowSpan={2} id="start-verde" className="verde vertical"><span className="celda vertical right-column numero">56</span> {renderFichasEnCelda("start-verde")}</td>
